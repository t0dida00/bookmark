...
const BookmarkFolder = () => {
    ...
    return (
        <div className="relative px-2 w-40">
            <div
                className="border border-gray-300 rounded-lg p-2 cursor-pointer flex items-end justify-between w-[150px]"
            ...
            {isOpen && (
                <div className="absolute mt-2 border border-gray-300 rounded-lg bg-white shadow-lg z-10 overflow-hidden w-[150px]">
                     {userData.data.bookmarks.map((bookmark, index) => <div
                        className="p-2 hover:bg-gray-100 cursor-pointer truncate flex justify-between items-end"
